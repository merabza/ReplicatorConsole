...
public sealed class ClearAllCliMenuCommand : CliMenuCommand
{
    private readonly ParametersManager _parametersManager;

    // ReSharper disable once ConvertToPrimaryConstructor
    public ClearAllCliMenuCommand(ParametersManager parametersManager) : base("Clear All", EMenuAction.Reload)
    {
