...
public sealed class ClearStepsCliMenuCommand : CliMenuCommand
{
    private readonly ParametersManager _parametersManager;

    // ReSharper disable once ConvertToPrimaryConstructor
    public ClearStepsCliMenuCommand(ParametersManager parametersManager) : base("Clear Steps", EMenuAction.Reload)
    {
